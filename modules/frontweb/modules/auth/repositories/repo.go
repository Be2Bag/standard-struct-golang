...
func NewAuthRepo(frontRepo *repositories.Repository) *AuthRepositories {
...
func (r AuthRepositories) Module() string {
	return moduleName
}

func (r AuthRepositories) AppCfg() *config.Config {
	return r.config
}

func (r AuthRepositories) Log() *logrus.Entry {
	return r.log.Dup()
}

func (r AuthRepositories) DB() *mongo.Database {
	return r.databaseMongo
}

func (r AuthRepositories) MophLine() *moph_line.Client {
	return r.mophLine
}

func (r AuthRepositories) MophAc() *moph_account_center.Client {
	return r.mophAcClient
}

func (r AuthRepositories) Trace(ctx context.Context, spanName string, attributes ...trace.SpanStartOption) (context.Context, trace.Span) {
	return r.tracer.Start(ctx, spanName, attributes...)
}

func (r AuthRepositories) HealthId() *health_id.HealthId {
	return r.healthId
}

func (r AuthRepositories) Provider() *provider.Provider {
	return r.provider
}

func (r AuthRepositories) Cache() *cache.Cache {
	return r.cache
}
